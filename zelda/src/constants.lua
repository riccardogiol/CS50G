...
MAP_LIMIT_TOP = MAP_RENDER_OFFSET_X + TILE_SIZE
MAP_LIMIT_BOTTOM = VIRTUAL_WIDTH - TILE_SIZE * 2 - 16
MAP_LIMIT_LEFT = MAP_RENDER_OFFSET_Y + TILE_SIZE
MAP_LIMIT_RIGHT = VIRTUAL_HEIGHT - (VIRTUAL_HEIGHT - MAP_HEIGHT * TILE_SIZE) + MAP_RENDER_OFFSET_Y - TILE_SIZE - 16
