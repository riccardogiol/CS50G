...
function EntityWalkState:update(dt)
    ...
    self:checkObjectCollision(dt)
end

function EntityWalkState:checkObjectCollision(dt)
    for i, obj in pairs(self.entity.room.objects) do
        if self.entity:collides(obj) and obj.solid then
            if self.entity.direction == 'left' then
                self.entity.x = self.entity.x + self.entity.walkSpeed * dt
            elseif self.entity.direction == 'right' then
                self.entity.x = self.entity.x - self.entity.walkSpeed * dt
